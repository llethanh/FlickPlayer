# Flick Player — notes Codex

Lu automatiquement à chaque session par Codex, ce fichier voyage
...
## Mémoire transverse (~/.Codex/MEMORY.md)

Si tu es sur la machine principale (lam), il existe une mémoire user
locale plus large dans `C:\Users\lam\.Codex\projects\...\memory\`
